...
function checkCollision(pacman, ghosts) {
  ...
  if (collidedGhost) {
    ...
    if (pacman.powerPill) {
      ...
      collidedGhost.pos = collidedGhost.starPos;
      score += 100;
    } else {
...
function gameLoop(pacman, ghosts) {
  ...
  checkCollision(pacman, ghosts); // Check to see Pacman eats Dots //
  ...
  } //Change Ghosts to Scare Mode w.Powerpill ///
  ...
  } // Check to see if all Dots have been eaten //
